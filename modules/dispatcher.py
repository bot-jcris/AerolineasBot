...
PAGE_ACCESS_TOKEN='EAAE2dBaZAQSIBAH8m68pdZAI8Wz4oo6Pb1WoCRG7DjTk6PM2ccbEieU2d9FFZCbnwywZCe2wFuyuMGD4dIdWgAdxFqRDgZCjgSAfRpoeVKDFb4lWqyaNQZBEl83iQ25aXLYZAWMxFcbHGlFWlZBBigbZBfAa0AstbapsKjZBxQwL05cQZDZD'
...
def get_user_info(sender_id):
    ...
    """
    url = INFO_URL.format(sender_id, PAGE_ACCESS_TOKEN)
...
def send_message(recipient_id, message_text, quick_replies=None):
    ...
    req = requests.post('https://graph.facebook.com/v2.6/me/messages?access_token={}'.format(PAGE_ACCESS_TOKEN),
                        params=params,
                        headers=headers,
                        data=data)
